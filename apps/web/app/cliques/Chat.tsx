...
export default function Chat({ cliqueId, topic }: { cliqueId: string, topic?: string }) {
  ...
  return (
    <div className="flex flex-col flex-1 min-h-0 w-full overflow-scroll">
      ...
      <div
        ref={scroller}
        className="row-start-2 row-end-3 flex-1 min-h-0 h-full overflow-y-auto w-full px-2 py-4 relative scroll-smooth custom-scrollbar overflow-scroll"
        style={{
          height: "600px",
